  ...
  return (
    <div className="w-full h-screen text-white text-center bg-circle-gradient from-blue-400 to-blue-800 flex items-center justify-center">
      <div className="flex flex-col w-fit h-fit absolute">
        <p className="w-[395.3px] md:w-fit text-start text-xl md:text-2xl font-bold text-white/80 mx-auto md:mr-0 md:ml-2 mb-2">
          OI 👋 EU SOU O{' '}
          <a href={links[0]} target="_blank">
            @LUIS
          </a>
        </p>
        <div className="flex gap-3 w-fit h-fit absolute right-[2.2rem] md:right-[2.2rem] top-[-0.5rem] md:top-[-1.2rem]">
          {icons.map((icon, i) => (
            <a
        ...
        <h1 className="text-7xl mx-auto leading-[3.9rem] md:text-9xl text-justify font-extrabold md:leading-[6.4rem]">
          FRONT-END
          <br />
          DEVELOPER
        </h1>
        <p className="w-[395.3px] md:w-fit text-end self-end text-xl md:text-2xl font-bold text-white/80 md:mr-2 mt-2 uppercase">
          na{' '}
